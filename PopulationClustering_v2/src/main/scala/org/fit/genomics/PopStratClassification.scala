...
object PopStratClassification {
  def main(args: Array[String]): Unit = {
    val genotypeFile = "C:/Users/admin-karim/Downloads/ALL.chrY.phase3_integrated_v2a.20130502.genotypes.vcf"
    ...
    val genotypes0 = sc.loadGenotypes("C:/Users/admin-karim/Downloads/VCF_files/1.vcf", stringency = ValidationStringency.SILENT)
    
    //val genotypes0 = sc.loadGenotypes("sample0.vcf")
    val genotypes1 = sc.loadGenotypes("C:/Users/admin-karim/Downloads/VCF_files/2.vcf")
   ...
   println(variantFrequencies.max)   
    ...
    deepLearningParameters._epochs = 2
    ...
    trainedModel.score(dataFrame)('predict)
    println(variantFrequencies.max)   
